...
association_matrix = pd.read_csv('./trans_data/data1/index_association.csv', header=0, index_col=0)
...
association_matrix.to_csv('./trans_data/data1/select_sample_disease_microbe_association_matrix.csv')
