...
all_associations = pd.read_csv('./trans_data/data2' + '/pair.txt', sep=' ', names=['d', 'm', 'label'])

interaction_marix = pd.read_csv("./trans_data/data2/index_association.csv", header=0, index_col=0)
...
print(sort_dis)
number = int(0.2*known_associations.shape[0])
...
interaction_marix.to_csv('./trans_data/data2/S_interaction.csv',header=None,index=False)
